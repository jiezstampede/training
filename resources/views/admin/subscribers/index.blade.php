  ...
  <div class="widget">
    <div class="header">
      ...
      <div class="pull-right">
        <a class="btn-transparent btn-sm" href="{{route('adminSubscribers')}}"><i class="fa fa-eye"></i> Show All</a>
        <a class="btn-transparent btn-sm" href="{{route('adminSubscribersCreate')}}"><i class="fa fa-plus-circle"></i> Create</a>
        <a class="btn-transparent btn-sm" href="#" data-toggle="modal" data-target="#delete-modal"><i class="fa fa-minus-circle"></i> Delete</a>
      </div>
    </div>
    <div class="filters">
      {!! Form::open(['route'=>'adminSubscribers', 'method' => 'get']) !!}
      <label>
    ...
    <div class="table-responsive">
      {!! Form::open(['route'=>'adminSubscribersDestroy', 'method' => 'delete', 'class'=>'form form-parsley form-delete']) !!}
          ...
          <tr >
            ...
            <td width="110px" class="text-center">
              <button type="button" class="btn btn-primary btn-xs" role="button" data-toggle="popover" 
                ...
                data-content="@include('admin.subscribers.show', ['data' => $d])">
                VIEW
              </button>
              <a href="{{route('adminSubscribersEdit', [$d->id])}}" class="btn btn-primary btn-xs">EDIT</a>
            </td>
          </tr>
          @endforeach
        </tbody>
