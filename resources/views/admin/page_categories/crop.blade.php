...
<ol class="breadcrumb">
  ...
  <li><a href="{{route('adminPageCategoriesEdit', [$data->id])}}">Edit</a></li>
...
<div class="col-sm-12">
  ...
  {!! Form::open(['route'=>['adminPageCategoriesCrop', $data->id], 'files' => true, 'method' => 'patch', 'class'=>'form form-parsley form-crop']) !!}
