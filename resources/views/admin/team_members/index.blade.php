  ...
  <div class="widget">
    <div class="header">
      ...
      <div class="pull-right">
        <a class="btn-transparent btn-sm" href="{{route('adminTeamMembers')}}"><i class="fa fa-eye"></i> Show All</a>
        <a class="btn-transparent btn-sm" href="{{route('adminTeamMembersCreate')}}"><i class="fa fa-plus-circle"></i> Create</a>
        <a class="btn-transparent btn-sm" href="#" data-toggle="modal" data-target="#delete-modal"><i class="fa fa-minus-circle"></i> Delete</a>
      </div>
    </div>
    <div class="filters">
      {!! Form::open(['route'=>'adminTeamMembers', 'method' => 'get']) !!}
      <label>
    ...
    <div class="table-responsive">
      {!! Form::open(['route'=>'adminTeamMembersDestroy', 'method' => 'delete', 'class'=>'form form-parsley form-delete']) !!}
      <table class="table table-bordered table-hover table-striped">
        ...
        <tbody class="sortable" sortable-data-url="{{route('adminTeamMembersOrder')}}">
          @foreach ($data as $d)
          <tr sortable-id="team_members-{{$d->id}}">
            ...
            <td width="110px" class="text-center">
              <button type="button" class="btn btn-primary btn-xs" role="button" data-toggle="popover" 
                ...
                data-content="@include('admin.team_members.show', ['data' => $d])">
                VIEW
              </button>
              <a href="{{route('adminTeamMembersEdit', [$d->id])}}" class="btn btn-primary btn-xs">EDIT</a>
            </td>
          </tr>
          @endforeach
        </tbody>
