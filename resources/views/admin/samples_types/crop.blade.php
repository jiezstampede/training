...
<ol class="breadcrumb">
  ...
  <li><a href="{{route('adminSamplesTypesEdit', [$data->id])}}">Edit</a></li>
...
<div class="col-sm-12">
  ...
  {!! Form::open(['route'=>['adminSamplesTypesCrop', $data->id], 'files' => true, 'method' => 'patch', 'class'=>'form form-parsley form-crop']) !!}
