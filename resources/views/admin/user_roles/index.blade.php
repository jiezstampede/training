  ...
  <div class="widget">
    <div class="header">
      ...
      <div class="pull-right">
        <a class="btn-transparent btn-sm" href="{{route('adminUserRoles')}}"><i class="fa fa-eye"></i> Show All</a>
        <a class="btn-transparent btn-sm" href="{{route('adminUserRolesCreate')}}"><i class="fa fa-plus-circle"></i> Create</a>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td width="110px" class="text-center">
              <a href="{{route('adminUserRolesEdit', [$d->id])}}" class="btn btn-primary btn-xs">EDIT</a>
            </td>
          </tr>
          @endforeach
        </tbody>
