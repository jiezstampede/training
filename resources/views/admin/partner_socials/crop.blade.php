...
<ol class="breadcrumb">
  ...
  <li><a href="{{route('adminPartnerSocialsEdit', [$data->id])}}">Edit</a></li>
...
<div class="col-sm-12">
  ...
  {!! Form::open(['route'=>['adminPartnerSocialsCrop', $data->id], 'files' => true, 'method' => 'patch', 'class'=>'form form-parsley form-crop']) !!}
