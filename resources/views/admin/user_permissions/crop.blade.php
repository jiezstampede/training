...
<ol class="breadcrumb">
  ...
  <li><a href="{{route('adminUserPermissions')}}">User Permissions</a></li>
  <li><a href="{{route('adminUserPermissionsEdit', [$data->id])}}">Edit</a></li>
...
<div class="col-sm-12">
  ...
  {!! Form::open(['route'=>['adminUserPermissionsCrop', $data->id], 'files' => true, 'method' => 'patch', 'class'=>'form form-parsley form-crop']) !!}
