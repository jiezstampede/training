...
Route::get('api/tests/find', array('as'=>'apiTestsFind','uses'=>'TestController@find', 'middleware'=>'cors'));
Route::get('api/tests/get', array('as'=>'apiTestsGet','uses'=>'TestController@get', 'middleware'=>'cors'));
Route::post('api/tests/store', array('as'=>'apiTestsStore','uses'=>'TestController@store', 'middleware'=>'cors'));
Route::post('api/tests/update', array('as'=>'apiTestsUpdate','uses'=>'TestController@update', 'middleware'=>'cors'));
Route::post('api/tests/destroy', array('as'=>'apiTestsDestroy','uses'=>'TestController@destroy', 'middleware'=>'cors'));
*/
}
